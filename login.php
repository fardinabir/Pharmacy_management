...
<head>
	...
	<style type="text/css">
		body
		{
			...
			background-image: url(Resources/illsdna.jpg);
		}
	</style>
</head>
<body>
	...
	<form action="validation_login.php" method="post">
		...
		<label style="color: white;"><br>Don't have an account ? Register <a href="register.php" style="color: #4dff4d; font-weight: bold; ">here. </a></label>
	</form>
</body>
</html>
